...
- If you need to click or extract data after scrolling, place [**Click Element**](/bot/workflow-built/node-types/click-element-node) / [**Extract Data**](/bot/workflow-built/node-types/extract-data-node) after this node.
