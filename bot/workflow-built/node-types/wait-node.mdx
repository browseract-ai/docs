...
![Set a fixed wait time in seconds](../../../images/wait-node-configuration.png)

**Recommendations**

- Recommended for use after nodes that trigger page changes, such as [**Click Element**](/bot/workflow-built/node-types/click-element-node), [**Visit Page**](/bot/workflow-built/node-types/visit-node), [**Pagination**](/bot/workflow-built/node-types/pagination-node), or [**Scroll**](/bot/workflow-built/node-types/scroll-page-node).
