...
- In [**Loop List**](/bot/workflow-built/node-types/loop-list-node)** + **[**Click Element Item**](/bot/workflow-built/node-types/click-element-item-node) scenarios, a common pattern is:
