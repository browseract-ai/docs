...
[![Watch Loop vs Loop List for Data Extraction](https://i.ytimg.com/vi/w0_hMrUztXY/hqdefault.jpg)](https://www.youtube.com/watch?v=w0_hMrUztXY)

[Watch **Loop vs Loop List for Data Extraction** on YouTube](https://www.youtube.com/watch?v=w0_hMrUztXY).

![Gemini_Generated_Image_7jw8xh7jw8xh7jw8.png](/images/Gemini_Generated_Image_7jw8xh7jw8xh7jw8.png)

**Use Cases**

- Repeating "[Pagination](/bot/workflow-built/node-types/pagination-node) + [Extraction](/bot/workflow-built/node-types/extract-data-node)" operations across multiple pages until a target data count is reached.
- Looping "[Scroll](/bot/workflow-built/node-types/scroll-page-node) + [Extraction](/bot/workflow-built/node-types/extract-data-node)" on infinite scroll pages until "No more data" appears.
...
- Loop is oriented towards controlling "action-level repetition," whereas item-by-item processing is better handled by [**Loop List**](/bot/workflow-built/node-types/loop-list-node).
