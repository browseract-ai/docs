...
### 2. [Visit Page](/bot/workflow-built/node-types/visit-node) (Open Amazon Homepage)
...
### 3. [Input Text](/bot/workflow-built/node-types/input-text-node) (Search Box Filter: Keyword = Laptop)
...
### 4. [Scroll to Element](/bot/workflow-built/node-types/scroll-to-element-node) (Scroll to Filter Area: HDD Size)
...
### 5. [Click Element](/bot/workflow-built/node-types/click-element-node) (Select HDD Size Filter)
...
### 6. [Scroll to Element](/bot/workflow-built/node-types/scroll-to-element-node) (Scroll to CPU Brand Filter Area)
...
### 7. [Click Element](/bot/workflow-built/node-types/click-element-node) (Select CPU Brand Filter)
...
### 8. [Loop List](/bot/workflow-built/node-types/loop-list-node) (Traverse Filtered Product List)
...
### 9. [Extract Data Item](/bot/workflow-built/node-types/extract-data-item-node) + Filtering Criteria (Content Filtering: Energy Efficiency Only)
...
### 10. Configure Output in Start (Export Filtered Results)
...
| **Open** Amazon homepage.                                                                                          | [**Visit Page**](/bot/workflow-built/node-types/visit-node)                                         | Starts the entire operation.                                                                |
| **Type** "Laptop" in top search box and press Enter.                                                               | [**Input Text**](/bot/workflow-built/node-types/input-text-node)                                    | **Layer 1 Filter:** Narrow scope from "All Site" to "Laptops."                              |
| **Scroll down** to find the HDD filter on the left.                                                                | [**Scroll to Element**](/bot/workflow-built/node-types/scroll-to-element-node) (HDD Size)            | Brings the filter section into view for reliable clicking.                                  |
| **Check** "1 TB" in the HDD section.                                                                               | [**Click Element**](/bot/workflow-built/node-types/click-element-node) (HDD Option)                 | **Layer 2 Filter (Part 1):** Use website filter to limit storage capacity.                  |
| **Scroll down** to find the CPU brand filter.                                                                      | [**Scroll to Element**](/bot/workflow-built/node-types/scroll-to-element-node) (CPU Brand)           | Brings the CPU filter section into view.                                                    |
| **Check** "Intel" in the CPU section.                                                                              | [**Click Element**](/bot/workflow-built/node-types/click-element-node) (CPU Option)                 | **Layer 2 Filter (Part 2):** Limit CPU brand.                                               |
| **Look** at the filtered results, ready to check one by one.                                                       | [**Loop List**](/bot/workflow-built/node-types/loop-list-node)                                      | Treats the middle product cards as a list and iterates through them.                        |
| **Check each item:** Read description. If it mentions "Energy efficiency," write down Name/Price. Otherwise, skip. | [**Extract Data Item + Filtering Criteria**](/bot/workflow-built/node-types/extract-data-item-node) | **Layer 3 Filter:** AI-based content filtering during scraping. Only saves matching items.  |
| **Compile** the final list of matching laptops into a CSV.                                                         | **Start output settings**                                                                     | Returns the multi-dimensionally filtered data in the selected format.                       |
