...
### 1. [Visit Page](/bot/workflow-built/node-types/visit-node) (Open TV Product List)
...
### 2. [Loop List](/bot/workflow-built/node-types/loop-list-node) (Traverse List + Auto-click Load More)
...
### 3. [Extract Data Item](/bot/workflow-built/node-types/extract-data-item-node) (Scrape Fields for Each Product)
...
| **Stop** when enough items are collected, and organize the list. | **Start output settings**                  | Returns all collected results in CSV/JSON.                                    |
