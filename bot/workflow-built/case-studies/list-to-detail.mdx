...
'og:image': "/images/Gemini_Generated_Image_rl8gq6rl8gq6rl8g.png"
---
...
### 1. [Visit Page](/bot/workflow-built/node-types/visit-node) (Open Website)
...
### 2. [Click Element](/bot/workflow-built/node-types/click-element-node) (Handling Random Pop-ups)
...
### 3. [Input Text](/bot/workflow-built/node-types/input-text-node) (Search Keywords)
...
### 4. [Loop List](/bot/workflow-built/node-types/loop-list-node) (Identify List)
...
### 5. [Click Element Item](/bot/workflow-built/node-types/click-element-item-node) (Enter Detail Page)
...
### 6. [Extract Data](/bot/workflow-built/node-types/extract-data-node) (Copy Data)
...
| **Save** the result file.                        | **Start output settings**         | Returns the data in the selected format.                                       |
