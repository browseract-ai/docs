...
sidebarTitle: "Case4: Conditional Scraping"
...
1. [**Loop List**](/bot/workflow-built/node-types/loop-list-node)**:** Responsible for focusing on each product card sequentially.
2. [**Condition**](/bot/workflow-built/node-types/condition-node)**:** Performs a judgment on each product.
...
### 1. [Visit Page](/bot/workflow-built/node-types/visit-node) (Open Search Results)
...
### 2. [Loop List](/bot/workflow-built/node-types/loop-list-node) (Traverse Product List)
...
### 3. [Condition](/bot/workflow-built/node-types/condition-node) (Check for Bulk Discount)
...
### 4. [Extract Data Item](/bot/workflow-built/node-types/extract-data-item-node) (True Branch: Scrape Matching Items)
...
| **Final Step:** Save the list of "Discounted Items" you collected.           | **Start output settings**           | Returns all recorded data in the selected CSV/JSON format.                        |
