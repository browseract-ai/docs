...
The Output Data node is the "closing node" of a workflow. It is specifically used to aggregate the results from all preceding [Extract Data](/workflow/learn/node-types/extract-data-node) / [Extract Data Item](/workflow/learn/node-types/extract-data-item-node) nodes and export them into a specified data format.
...
- Ensure there is at least one [Extract Data](/workflow/learn/node-types/extract-data-node) / [Extract Data Item](/workflow/learn/node-types/extract-data-item-node) node before Output Data; otherwise, the output will be empty.
