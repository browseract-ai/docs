...
- In [**Loop List**](/workflow/learn/node-types/loop-list-node)** + **[**Click Element Item**](/workflow/learn/node-types/click-element-item-node) scenarios, a common pattern is:
