...
- Entering keywords in a search box and triggering a search with [Click Element](/workflow/learn/node-types/click-element-node).
...
- For scenarios where pages load slowly, consider adding a [**Wait**](/workflow/learn/node-types/wait-node) node before Input Text.