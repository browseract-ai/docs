...
- Repeating "[Pagination](/workflow/learn/node-types/pagination-node) + [Extraction](/workflow/learn/node-types/extract-data-node)" operations across multiple pages until a target data count is reached.
- Looping "[Scroll](/workflow/learn/node-types/scroll-page-node) + [Extraction](/workflow/learn/node-types/extract-data-node)" on infinite scroll pages until "No more data" appears.
...
- Loop is oriented towards controlling "action-level repetition," whereas item-by-item processing is better handled by [**Loop List**](/workflow/learn/node-types/loop-list-node).
