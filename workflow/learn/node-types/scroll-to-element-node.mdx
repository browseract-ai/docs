...
- If you need to click or extract data after scrolling, place [**Click Element**](/workflow/learn/node-types/click-element-node) / [**Extract Data**](/workflow/learn/node-types/extract-data-node) after this node.
