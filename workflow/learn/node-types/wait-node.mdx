...
- Recommended for use after nodes that trigger page changes, such as [**Click Element**](/workflow/learn/node-types/click-element-node), [**Visit Page**](/workflow/learn/node-types/visit-node), [**Pagination**](/workflow/learn/node-types/pagination-node), or [**Scroll**](/workflow/learn/node-types/scroll-page-node).
