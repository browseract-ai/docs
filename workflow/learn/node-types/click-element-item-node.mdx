...
- Supports continuing with [**Extract Data**](/workflow/learn/node-types/extract-data-node) or other operations after clicking.

**Configuration Steps**

1. Add a [**Click Element Item**](/workflow/learn/node-types/click-element-item-node) node inside a [**Loop List**](/workflow/learn/node-types/loop-list-node).
...
3. After clicking, you can attach [**Extract Data**](/workflow/learn/node-types/extract-data-node) or other nodes within the same loop to complete scraping on the detail page.
