...
The Pagination node is used to automatically turn pages in multi-page content, such as clicking "Next Page" or "Previous Page" buttons. It works with [extraction](/workflow/learn/node-types/extract-data-node) nodes to implement batch collection across multiple pages.
...
- Can generate multi-page loops when combined with [Extract Data](/workflow/learn/node-types/extract-data-node), [Loop List](/workflow/learn/node-types/loop-list-node), Loop, and [Scroll](/workflow/learn/node-types/scroll-page-node) nodes.
...
4. Usually place Pagination after [**Extract Data**](/workflow/learn/node-types/extract-data-node) to ensure current page data is collected before turning the page.
