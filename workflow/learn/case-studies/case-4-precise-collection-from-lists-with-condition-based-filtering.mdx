...
1. [**Loop List**](/workflow/learn/node-types/loop-list-node)**:** Responsbile for focusing on each product card sequentially.
2. [**Condition**](/workflow/learn/node-types/condition-node)**:** Performs a judgment on each product.
...
### 1. [Visit Page](/workflow/learn/node-types/visit-node) (Open Search Results)
...
### 2. [Loop List](/workflow/learn/node-types/loop-list-node) (Traverse Product List)
...
### 3. [Condition](/workflow/learn/node-types/condition-node) (Check for Bulk Discount)
...
### 4. [Extract Data Item](/workflow/learn/node-types/extract-data-item-node) (True Branch: Scrape Matching Items)
