...
### 1. [Visit Page](/workflow/learn/node-types/visit-node) (Open Website)
...
### 2. [Click Element](/workflow/learn/node-types/click-element-node) (Handling Random Pop-ups)
...
### 3. [Input Text](/workflow/learn/node-types/input-text-node) (Search Keywords)
...
### 4. [Loop List](/workflow/learn/node-types/loop-list-node) (Identify List)
...
### 5. [Click Element Item](/workflow/learn/node-types/click-element-item-node) (Enter Detail Page)
...
### 6. [Extract Data](/workflow/learn/node-types/extract-data-node) (Copy Data)
