...
### 1. [Visit Page](/workflow/learn/node-types/visit-node) (Open TV Product List)
...
### 2. [Loop List](/workflow/learn/node-types/loop-list-node) (Traverse List + Auto-click Load More)
...
### 3. [Extract Data Item](/workflow/learn/node-types/extract-data-item-node) (Scrape Fields for Each Product)
