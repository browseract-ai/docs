...
### Add or Select an MCP Server

Select `Add` to create an MCP Server.

![Add an MCP Server](../images/mcp-server-list-add.png)

After the server is created, expose the Bot as an MCP Tool and connect the MCP Server URL and API Key to your MCP client.
