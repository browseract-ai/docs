...
<Columns cols={2}>
  <Card title="Continue to Quick Start" icon="rocket" href="/skill/quickstart" cta="Run the first task">
    Run a content extraction or a browser session in about a minute.
  </Card>
  <Card title="Learn the Skill System" icon="layers" href="/skill/skills" cta="Understand the runtime">
