...
| Goal | Page |
| --- | --- |
| Choose the right browser mode | [Browser Modes](/skill/browser-modes) |
| Handle blocking | [Anti-detection & Blocking](/skill/anti-blocking) |
| Hand control to a human | [Better Headless Browser](/skill/headless) |
| Run concurrent work | [Concurrency & Isolation](/skill/concurrency) |
| Look up every command | [Command Reference](/skill/commands) |
| Generate reusable scrapers | [Skill Forge](/skill/skill-forge) |
