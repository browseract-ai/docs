...
<Columns cols={3}>
  ...
  <Card title="Designed for Agents" icon="brain-circuit" href="/skill/agent-design" cta="Understand rules">
    See how naming, selection, and safety rules help agents operate cleanly.
  </Card>
  <Card title="Command Reference" icon="terminal" href="/skill/commands" cta="Find commands">
