...
<Columns cols={3}>
  <Card title="Anti-detection & Blocking" icon="shield-check" href="/skill/anti-blocking" cta="Escalate safely">
  ...
  <Card title="Designed for Agents" icon="brain-circuit" href="/skill/agent-design" cta="Use descriptions">
