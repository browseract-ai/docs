...
<Columns cols={3}>
  <Card title="Better Headless Browser" icon="eye-off" href="/skill/headless" cta="Use headless">
    Understand how handoff works with headless sessions.
  </Card>
  <Card title="Anti-detection & Blocking" icon="shield-check" href="/skill/anti-blocking" cta="Try automatic solving">
    Use automatic escalation before handoff when appropriate.
  </Card>
  <Card title="Designed for Agents" icon="bot" href="/skill/agent-design" cta="Review safety">
