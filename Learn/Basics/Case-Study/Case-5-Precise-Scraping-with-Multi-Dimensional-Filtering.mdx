...
sidebarTitle: "Multi-Dimensional Filter Scraping"
---
...
### 2. Visit Page (Open Amazon Homepage)
...
> _[Image: Visit Page configuration showing the Amazon URL]_

### 3. Input Text (Search Box Filter: Keyword = Laptop)
...
> _[Image: Input Text configuration showing "Laptop" and "Press Enter" checked]_

### 4. Scroll to Element (Scroll to Filter Area: HDD Size)
...
> _[Image: Scroll to Element configuration targeting the sidebar filter]_

### 5. Click Element (Select HDD Size Filter)
...
> _[Image: Click Element configuration showing the specific filter option]_

### 6. Scroll to Element (Scroll to CPU Brand Filter Area)
...
> _[Image: Scroll to Element configuration targeting the CPU filter]_

### 7. Click Element (Select CPU Brand Filter)
...
> _[Image: Click Element configuration showing the specific CPU option]_

### 8. Loop List (Traverse Filtered Product List)
...
> _[Image: Loop List configuration showing the filtered list region]_

### 9. Extract Data Item + Filtering Criteria (Content Filtering: Energy Efficiency Only)
...
> _[Image: Extract Data Item configuration showing Filtering Criteria checked]_
...
> _[Image: Finish configuration showing output settings]_
...
| **Open** Amazon homepage.                                                                                          | **Visit Page**                             | Starts the entire operation.                                                                |
| **Type** "Laptop" in top search box and press Enter.                                                               | **Input Text**                             | **Layer 1 Filter:** Narrow scope from "All Site" to "Laptops."                              |
| **Scroll down** to find the HDD filter on the left.                                                                | **Scroll to Element** (HDD Size)           | Brings the filter section into view for reliable clicking.                                  |
| **Check** "1 TB" in the HDD section.                                                                               | **Click Element** (HDD Option)             | **Layer 2 Filter (Part 1):** Use website filter to limit storage capacity.                  |
| **Scroll down** to find the CPU brand filter.                                                                      | **Scroll to Element** (CPU Brand)          | Brings the CPU filter section into view.                                                    |
| **Check** "Intel" in the CPU section.                                                                              | **Click Element** (CPU Option)             | **Layer 2 Filter (Part 2):** Limit CPU brand.                                               |
| **Look** at the filtered results, ready to check one by one.                                                       | **Loop List**                              | Treats the middle product cards as a list and iterates through them.                        |
| **Check each item:** Read description. If it mentions "Energy efficiency," write down Name/Price. Otherwise, skip. | **Extract Data Item + Filtering Criteria** | **Layer 3 Filter:** AI-based content filtering during scraping. Only saves matching items.  |
