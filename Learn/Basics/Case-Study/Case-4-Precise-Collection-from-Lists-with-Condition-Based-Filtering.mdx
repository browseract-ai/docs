...
> _[Image: Visit Page configuration showing the eBay URL]_
...
> _[Image: Loop List configuration showing the list region selection]_
...
> _[Image: Condition configuration showing the specific text check]_
...
> _[Image: Extract Data Item configuration showing fields selected]_
...
> _[Image: Finish configuration showing the output settings]_
