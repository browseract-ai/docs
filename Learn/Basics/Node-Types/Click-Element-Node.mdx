...
- If the target element is not in the current visible area, use [**Scroll**](/Learn/Basics/Node-Types/Scroll-Page-Node) nodes first to bring it into view.
- It is recommended to place Click Element nodes after [Visit Page](/Learn/Basics/Node-Types/Visit-Node), [Input Text](/Learn/Basics/Node-Types/Input-Text-Node), or [Scroll nodes](/Learn/Basics/Node-Types/Scroll-Page-Node).