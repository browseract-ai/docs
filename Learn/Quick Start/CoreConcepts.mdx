...
| :---------------------------------- | :------------------------------- |
| Open a URL                          | **Open Page** node               |
| Type text into a search box         | **Fill Input** node              |
| Click a “Search” button             | **Click Element** node           |
| Scroll down the page                | **Scroll Page** node             |
| Click “Next page”                   | **Pagination / Click Next** node |
| Read title, price, or other fields  | **Extract Data / Fields** node   |
| Repeat the same steps for each item | **Loop / For Each Item** node    |
...
You can now go to the **Templates** gallery, pick any workflow, and use this mental model to see:
